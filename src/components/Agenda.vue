<template>
  <v-card color="white" class="rounded-lg" flat>
    <v-sheet tile height="54" class="d-flex">
        ...
        <v-select v-model="type" :items="types" dense outlined hide-details label="type"></v-select>
        <v-select v-model="mode" :items="modes" dense outlined hide-details label="event-overlap-mode" class="ma-2"></v-select>
        <v-select v-model="weekday" :items="weekdays" dense outlined hide-details label="weekday" class="ma-2"></v-select>
        <v-spacer></v-spacer>
